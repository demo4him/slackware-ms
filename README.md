...
You can choose the file (lftp downloads + installpkg */*.t?z) for DE.
...
To be appreciated: Repositories are from https://slackware.uk, except ponce’s one (http://ponce.cc/slackware/slackware64-15.0/lxde/). DEs scripts,which I wrote, are based on lftp command and pkgtool. All credits to them and to slackware’s and linux world! Thanks for sharing!
